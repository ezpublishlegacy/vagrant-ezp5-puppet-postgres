...
- By default Xdebug is enable, if you want to disble it, go to line 55 of Vagrantfile comment it and uncomment line 58. Don't forget to run `$ vagrant up` after
